<template>
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      ...
      <br/>
      服务器：
      <el-input @keyup.enter.native="handleFilter" style="width: 200px;" placeholder='服务器'
                v-model="listQuery.serverName"></el-input>
      欧泊：
      <el-input @keyup.enter.native="handleFilter" style="width: 200px;" placeholder='欧泊1'
                v-model="listQuery.oubo1"></el-input>
      -
      <el-input @keyup.enter.native="handleFilter" style="width: 200px;" placeholder='欧泊2'
                v-model="listQuery.oubo2"></el-input>
      <br/>
      登录天数：
      <el-input @keyup.enter.native="handleFilter" style="width: 200px;" placeholder='登录天数1'
                v-model="listQuery.sign_times_1"></el-input>
      -
      <el-input @keyup.enter.native="handleFilter" style="width: 200px;" placeholder='登录天数2'
                v-model="listQuery.sign_times_2"></el-input>
      签到天数：
      <el-input @keyup.enter.native="handleFilter" style="width: 200px;" placeholder='签到天数1'
                v-model="listQuery.sign_day_1"></el-input>
      -
      <el-input @keyup.enter.native="handleFilter" style="width: 200px;" placeholder='签到天数2'
                v-model="listQuery.sign_day_2"></el-input>
      错误次数：
    ...
    <el-table :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border fit
              highlight-current-row style="width: 100%;margin-top:15px;">
  ...
  methods: {
    ...
    editStatus (row, handleType) {
      ...
      if (handleType === 'confirm') {
        ...
        let postData2 = {
          'sql': 'update game_f7_account_detail set game_status = ' + row.status + ' where account_id = ' + row.id,
          'passwd': 'benibenija',
          'type': 'sql'
        }
