<template>
    <div class="app-container calendar-list-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border fit highlight-current-row style="width: 100%;margin-top:15px;">
            <el-table-column width="175px"  label="order_id" prop="order_id"></el-table-column>
            ...
            <el-table-column width="130px"  label="origin_content" prop="origin_content">
                <template slot-scope="{row}">
                    <el-button @click="showContent(row.origin_content)">详细</el-button>
                </template>
            </el-table-column>
            <el-table-column width="130px"  label="easy_content" prop="easy_content">
                <template slot-scope="{row}">
                    <el-button @click="showContent(row.easy_content)">详细</el-button>
                </template>
            </el-table-column>
        </el-table>
    ...
    export default {
        ...
        methods: {
            getList () {
                ...
                request({ url: 'taobao/orderLists', method: 'post', params: this.listQuery }).then(response => {
