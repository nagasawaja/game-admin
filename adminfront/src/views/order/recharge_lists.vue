<template>
    <div class="app-container calendar-list-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border fit
            ...
            <el-table-column width="150px" label="trade_no" prop="trade_no"></el-table-column>
            <el-table-column width="75px" label="user_id" prop="user_id"></el-table-column>
            <el-table-column width="100px" label="product_id" prop="product_id"></el-table-column>
            <el-table-column width="150px" label="total_fee" prop="total_fee"></el-table-column>
            <el-table-column width="150px" label="total_coins" prop="total_coins"></el-table-column>
            <el-table-column width="150px" label="status" prop="status">
                <template slot-scope="scope">
                    {{constant.label_['trade_no']}}
                </template>
            </el-table-column>
    ...
    export default {
        ...
        methods: {
            getList() {
                ...
                request({url: 'order/recharge-order', method: 'get', params: this.listQuery}).then(response => {
